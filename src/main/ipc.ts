...
export function registerIpcHandlers(): void {
  ...
  ipcMain.handle('lyrics:generate', (_event, request: LyricsDraftRequest) => generateLyricsDraft(request))
  ipcMain.handle('lyrics:prompt', (_event, request: PromptFromLyricsRequest) => generatePromptFromLyrics(request))
