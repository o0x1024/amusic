...
import type { AppSettings, FavoriteRecord, HistoryRecord, ModelConfig, SongRequest } from '../shared/types'
import { generateSong, listModels, testModelConnection } from './ai-service'
